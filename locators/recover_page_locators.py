...
class RecoverPageLocators:
    ...
    RECOVERY_PASSWORD_BUTTON = (By.XPATH, "//button[(text()='Восстановить')]")                                 # кнопка восстановить

    PASSWORD_VISIBILITY = (By.XPATH, ".//div[contains(@class, 'input__icon')]/*[1]")                           # Кнопка видимости пароля в форме восстановления
