...
class SetNewPasswordPage(BasePage):
    ...
    @allure.step("Кнопка Сохранить на экране восстановления (там где надо ввести новый пароль и кодь из письма")
    ...
    @allure.step("Метод кликает по кнопке видимости пароля")
    ...
    @allure.step("Метод возвращает в ассерт подсвеченное поле ввода пароля")
