...
class LoginPage(BasePage):
    ...
    @allure.step('Заполнение полей email И пароль на странице логина')
    ...
    @allure.step('Клик по кнопке Войти на странице логина (авторизации)')
    def click_login_button_on_login_page(self):

        self.wait_and_click_element(LoginPageLocators.LOGIN_BUTTON)

    @allure.step('Прокрутка до кнопки восстановления пароля')
